...
public class GroupTripDashboardActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_trip_dashboard);
    ...
    {
        startActivity(new Intent(GroupTripDashboardActivity.this, GroupTripChatWindowActivity.class));
    }
