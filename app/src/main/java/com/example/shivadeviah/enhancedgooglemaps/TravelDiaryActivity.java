...
public class TravelDiaryActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener, GoogleMap.OnMarkerClickListener {
    ...
    public void displayReview(){
        ...
        View layout = inflater.inflate(R.layout.travel_diary_foo,
    ...
    public void displayTrips(){
        ...
        //Inflate the view from a predefined XML layout
        View layout = inflater.inflate(R.layout.travel_diary_trip_table,
    ...
    public void contTripAction(View view){
        ...
        //Inflate the view from a predefined XML layout
        View layout = inflater.inflate(R.layout.travel_diary_continue,
    ...
    public void continueTripAction(View view){
        ...
        if((count == -1) || (!(isFine))){
            Toast.makeText(TravelDiaryActivity.this, "INVALID TRIP", Toast.LENGTH_LONG).show();
            tripId = oldTripId;
            count = oldCount;
